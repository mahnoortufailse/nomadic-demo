...
export default function BookingPage() {
    ...
    try {
      ...
      if (data.lockedLocation) {
        ...
        if (data.remainingCapacity <= 0) {
          setLocationMessage(
            `This date is fully booked (10 tents maximum per day)`
          );
        } else {
          setLocationMessage(
  ...
  const handleTentChange = (increment: boolean) => {
    ...
    const maxAllowed = Math.min(
      maxTentsPerBooking,
      dateConstraints.remainingCapacity || 10
    );
        ...
        <div className="mb-4 sm:mb-6 lg:mb-8 animate-fade-in-up">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-2 sm:gap-3 lg:gap-4 mb-3 sm:mb-4 lg:mb-6">
            <div className="lg:col-span-3">
              <div className="relative h-[250px] xs:h-[300px] sm:h-[400px] md:h-[500px] lg:h-[550px] rounded-lg sm:rounded-xl overflow-hidden shadow-xl group">
                <Image
                  src={
            ...
            <div className="grid grid-cols-4 sm:grid-cols-2 lg:grid-cols-1 gap-1 sm:gap-2">
              {campingImages.slice(1, 5).map((image, index) => (
                <div
                  key={index}
                  className="relative h-[60px] xs:h-[70px] sm:h-[90px] md:h-[110px] lg:h-[130px] rounded-md sm:rounded-lg overflow-hidden shadow-md cursor-pointer group transition-all duration-300 hover:shadow-xl hover:scale-105"
          ...
          <div className="text-center lg:text-left mb-3 sm:mb-4 lg:mb-6">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-2 sm:mb-3 lg:mb-4">
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-2 sm:gap-3 mb-2 sm:mb-3 lg:mb-0 px-2 sm:px-0">
            ...
            <p className="text-xs sm:text-sm md:text-base text-[#3C2317]/80 max-w-2xl text-pretty mx-auto lg:mx-0 px-2 sm:px-0 leading-relaxed">
              Experience the UAE's most luxurious camping adventure with premium
              amenities, breathtaking locations, and unforgettable memories
              under the stars.
            </p>
          </div>
        </div>
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem
                        ...
                        disabled={
                          dateConstraints.lockedLocation &&
                          dateConstraints.lockedLocation !== "Desert"
                        }
                      >
                        🏜️ Desert
                        {dateConstraints.lockedLocation &&
                        ...
                        <div className="p-2 sm:p-3 bg-gradient-to-r from-red-50 to-pink-50 border border-red-200 rounded-lg">
                          <div className="flex items-center space-x-2">
                            ...
                            <span className="text-xs sm:text-sm font-medium text-red-800">
                              Wadi requires 2 tents and on this date max{" "}
                              {dateConstraints.remainingCapacity} tent
                              {dateConstraints.remainingCapacity === 1
                                ? ""
                                : "s"}{" "}
                              you can book, so choose another date for this
                              place
                            </span>
                          </div>
                        </div>
                ...
                <CardContent className="p-3 sm:p-4 lg:p-6 space-y-3 sm:space-y-4 !pt-0">
                    ...
                    <div>
                      ...
                      <div className="flex items-center justify-center space-x-2">
                        ...
                        <Button
                          ...
                          disabled={
                            adults >= 20 ||
                            adults + children >= formData.numberOfTents * 4
                          }
                          className="border-2 border-[#D3B88C] hover:border-[#3C2317] cursor-pointer hover:bg-[#D3B88C] transition-all duration-300 h-7 w-7 sm:h-8 sm:w-8 rounded-lg p-0"
                        >
                          <Plus className="h-3 w-3" />
                  ...
                  <div className="text-center p-2 rounded-lg">
                    <p className="text-xs text-[#3C2317]/70">
                      Each tent accommodates up to 4 guests • Total capacity:{" "}
                      {formData.numberOfTents * 4} guests
                    </p>
                  </div>
                  ...
                  {formData.numberOfTents >= 5 && (
                    <div className="text-center p-2 bg-amber-50 border border-amber-200 rounded-lg">
                      <p className="text-xs text-amber-800 font-medium">
                        For larger bookings or special requests, please enquire
                  ...
                  {formData.numberOfTents > 0 && (
                    <div className="mt-3 sm:mt-4">
                      ...
                      <div className="text-xs text-[#3C2317]/60 mb-2 sm:mb-3">
                        Configure how guests will sleep in each tent (max 4
                        guests per tent)
                      </div>
                        ...
                        {formData.sleepingArrangements.map((arrangement) => (
                          ...
                          >
                            ...
                            <Select
                              ...
                              onValueChange={(
                                value: "all-singles" | "two-doubles" | "mix"
                              ) =>
                  ...
                  <CardContent className="p-3 sm:p-4 lg:p-5 !pt-0">
                    <ul className="divide-y divide-[#3C2317]/15 text-xs sm:text-sm text-[#3C2317]">
                      {[
                        ...
                        <li
                          key={i}
                          className="py-1.5 sm:py-2 flex items-center"
                        >
                  ...
                  <CardContent className="p-3 sm:p-4 lg:p-5 !pt-0">
                    ...
                    <div className="mt-3 sm:mt-4 lg:mt-5 p-3 sm:p-4 bg-[#E6CFA9]/60 rounded-lg sm:rounded-xl border border-[#D3B88C]/30">
                      <p className="text-xs text-[#3C2317] leading-relaxed">
                        💡 <span className="font-semibold">Pro Tip:</span> Bring
                        your own food & drinks for a personalized experience!
                      </p>
                    </div>
                  </CardContent>
                </Card>
                        ...
                        <div className="flex items-start space-x-2 sm:space-x-3">
                          ...
                          <div>
                            <p className="text-red-800 font-semibold text-xs sm:text-sm">
                              Wadi Location Requirement
                            </p>
                            <p className="text-red-700 text-xs mt-1 leading-relaxed">
                              Minimum 2 tents required for Wadi bookings due to
